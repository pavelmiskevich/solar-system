...
npm test            # 314 юнит-тестов
npm run e2e         # 74 сквозных теста, Playwright + Chromium
```
...
астрономических событий, пояс астероидов, комета Галлея, тач-управление и
английская локализация. Как всё это устроено - в
