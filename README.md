...
[![Тесты](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D1%8B-241%20%2B%2042-729B1B?logo=vitest&logoColor=white)](#проверка)
...
npm test            # 241 юнит-тест
npm run e2e         # 42 сквозных теста, Playwright + Chromium
```
...
и в [задачах](https://github.com/pavelmiskevich/solar-system/issues): орбитальная
камера вокруг выбранного тела, ввод даты, готовые сценарии вроде затмений и
великих противостояний, взаимные тени тел, атмосферное рассеяние Земли, пояс
астероидов. Как всё это устроено — в [ROADMAP.md](ROADMAP.md).
