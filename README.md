...
| | |
|---|---|
| **Тел в сцене** | 24: Солнце, восемь планет, Плутон и четырнадцать спутников - от Фобоса до Харона |
...
npm test            # 365 юнит-тестов
npm run e2e         # 89 сквозных тестов, Playwright + Chromium
```
