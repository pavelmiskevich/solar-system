...
и в [задачах](https://github.com/pavelmiskevich/solar-system/issues): парады планет с
точными датами, английская локализация, остальные крупные спутники, пояс
астероидов, созвездия с разных планет, комета Галлея.
