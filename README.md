...
src/
  ...
  scene/      тела, кольца, орбиты планет и спутников, звёздное небо, Солнце
  ...
  data/       определения тел, внешний вид, каталог звёзд, готовые виды
...
астероидов, комета Галлея, названия ярких звёзд и линии созвездий, Млечный Путь,
тач-управление и английская локализация. Как всё это устроено — в
