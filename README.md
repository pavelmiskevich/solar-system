...
[![Тесты](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D1%8B-293%20%2B%2071-729B1B?logo=vitest&logoColor=white)](#проверка)
...
npm test            # 293 юнит-теста
npm run e2e         # 71 сквозной тест, Playwright + Chromium
```
