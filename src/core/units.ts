 ...
 *
 * Округление до целой миллисекунды, а не отбрасывание остатка. Юлианская
 * дата — число суток, и миллисекунда стоит в ней на одиннадцатом знаке: круг
 * «дата → юлианская → дата» промахивается мимо целой миллисекунды на доли, а
 * `Date` отбрасывает их вниз. Момент возвращался на миллисекунду раньше, и
 * при обрезке до секунд это стоило целой секунды: ссылка обещала 05:53:13,
 * сцена показывала 05:53:12.
 */
