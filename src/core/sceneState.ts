 ...
 *
 * Угол, уже лежащий в диапазоне, возвращается как есть. Иначе деление с
 * остатком добавляет ему хвост в последнем знаке: −119.7 превращается в
 * −119.69999999999999, и вид, прошедший через адрес страницы, перестаёт
 * совпадать с исходным по сравнению без допуска.
 */
