...
export class OrbitControls {
  ...
  /**
   * Азимут и возвышение камеры вокруг тела, радианы.
   *
   * Наружу они нужны затем же, зачем `radius`: этими тремя числами вид
   * вокруг тела записывается в адрес страницы и восстанавливается из него.
   * Управлять ими снаружи нельзя — режим ведёт их сам, сглаживая.
   */
