...
const LORE: Readonly<Record<string, BodyLore>> = {
   ...
   * с лишним, у перигелия дневная сторона прогревается до плюс пятидесяти.
   * Здесь стоит второе - то, что измерил «Джотто» в марте 1986 года с
   * шестисот километров, - потому что смотреть на комету имеет смысл именно
   * тогда, когда она деятельна.
   */
  halley: {
    temperatureC: 47,
