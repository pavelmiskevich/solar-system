...
export const APPEARANCE: Record<string, Appearance> = {
  ...
  /*
   * Ядро Галлея - одно из самых тёмных тел системы: корка органики отражает
   * четыре процента света, темнее печной сажи. Рельеф крупный: «Джотто» снял
   * холмы и впадины в километр высотой на теле в одиннадцать километров,
   * потому доля здесь на порядок больше, чем у планет.
   */
  halley: {
    ...NONE,
    family: 'rocky',
