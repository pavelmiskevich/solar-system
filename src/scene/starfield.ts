 ...
 *
 * Общий со всей разметкой неба: линии созвездий обязаны лежать на той же
 * сфере, что и звёзды, иначе они разойдутся со звёздами на параллаксе.
 */
export const SKY_RADIUS = 1e11;
